...
export default function ListCard({item}:any) {
    return (    
        <div onClick={()=>toggleItemTaken({item,currentPath:'/list'})} className="flex justify-between mx-auto mt-2 transform overflow-hidden rounded-lg bg-white dark:bg-slate-800 shadow-md duration-300 ">
